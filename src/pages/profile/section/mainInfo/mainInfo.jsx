...
import { changeName, changeSurname, changeStatus, saveStatus } from '../../../../redux/profile-reducer'
        ...
        <>
          {location.pathname === '/profile' && (
            <>
              ...
              <div className={`${s.name_status}`}>
                ...
                {editStatus && <input value={status} onChange={handleChangeStatus} onBlur={handleSaveStatus} />}
              </div>
            </>
          )}
          {location.pathname === '/edit-my-profile' && (
            <>
              ...
              <div className={`${s.name_status}`}>
                <div className={`${s.name}`}>
                  <input value={name} placeholder='Имя' onChange={handlerChangeName} />
                  <input value={surname} placeholder='Фамилия' onChange={handlerChangeSurname} />
                </div>
              </div>
            </>
          )}
